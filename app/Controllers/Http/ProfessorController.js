...
class ProfessorController {
  ...
  async index ({ request, response, view }) {
    let{page, perPage} = request.all()
      return Professor.query().paginate(page, perPage)
  }
  ...
  async store ({ request, response }) {
    const campos = ['nome', 'cpf', 'matricula', 'salario', 'email', 'telefone']
    const professor = request.only(campos)
  ...
  async update ({ params, request, response }) {
    const campos = Professor.getCamposCadastro()
